...
// Re-exported so existing importers (e.g. app/exam, lib/mistakes) keep working
// while the definitions live in the lightweight lib/mcq-meta module.
export { COMPETENCY_LABEL, inferCompetency, mcqMeta, type McqMeta } from "./mcq-meta";
